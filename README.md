...
Для каждого пользователя выделяем 60 секунд на распознавание трека и получение информации о нем.(Учитываем медленных клиентов)
Тогда, имеем при среднем размере записи об сессии - 1 Мб:
1300 * 60 * 1 Мб = 78 Гб на хранение сессий пользователей.
...
|:------:|:------:|:------:|:------:|
| Индексирование треков| 16 | 128 | 15 |
| Поиск по хешу | 8 | 64 | 10 |
| Фронтенд | 8 | 32 | 10 |
