...
- Согласно оценке консалтинговой компании Midia Research[ССЫЛОЧКА], которая регулярно обновляет свои оценки, 
    на конец марта 2020 года музыкальными сервисами ежедневно пользуются 400 миллионов людей.
- 5% всей скачиваемой/добавляемой на стриминговых сервисах музыки, приходится на предложенную данным сервисом.[ССЫЛОЧКА]
- Сервисом пользуется более 150 миллионов людей ежемесячно.[ССЫЛОЧКА]
- Активные пользователи Shazam совершают более 20 миллионов запросов на поиск музыки ежедневно.[ССЫЛОЧКА]
...
Согласно статье[ссылка на статью об индексировании вк] об индексировании музыкальной библиотеки ВК, насчитывающей 
...
См [PDFка из доки шазама Пункт 3.2]

<h3>Расчет потребного оборудования</h3>

По данным на 2008-2012 год, Shazam использовал сервера TYAN GT24 B2891 с двухъядерными процессорами
AMD серии Opteron 2000 и оперативной памятью DDR400 на 16 Гб. [Ссылочка на тян]
...
Одним из решений является AWS с инстансами Amazon EC2 C5.
EC2 C5 отличается:
...
По умолчанию, Amazon EC2 позволяет иметь не более 20 инстансов на регион. Увеличение количества инстансов рассматривается после обращения в поддержку.
